  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="w-[680px] bg-white dark:bg-neutral-900 rounded shadow-lg border border-gray-200 dark:border-neutral-700">
        <div className="px-4 py-2 border-b text-sm font-semibold bg-gray-50 dark:bg-neutral-800 dark:text-neutral-100">{t('connection.new')} (SQLite)</div>
        ...
        <div className="px-5 pb-4">
          ...
          <div className="grid grid-cols-[120px_1fr] gap-y-3 gap-x-4 items-center">
            ...
            <div className="flex gap-2">
              ...
              <button className="px-3 py-1 border rounded text-sm hover:bg-gray-50" onClick={browseFile}>{t('common.loading')}</button>
            </div>
          ...
          {tab==='advanced' && (
            <div className="grid grid-cols-[140px_1fr] gap-y-3 gap-x-4 items-center">
              <label className="text-right text-sm">{t('common.loading')}:</label>
              ...
              <input className="border rounded px-2 py-1 text-sm w-32" defaultValue={2000} placeholder={t('table.rows')} />
              ...
              <label className="text-right text-sm">{t('connection.advanced.compatibility')}:</label>
              <select className="border rounded px-2 py-1 text-sm">
